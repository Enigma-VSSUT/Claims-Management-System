...
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(1,101,201,5000.0,25,150000.00);
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(2,102,203,8000.0,21,100000.00);
insert into policy (policy_id,policy_number,benefit_id,premium,tenure,cap_amount_benefits) values(3,103,203,15000.0,14,80000.00);
