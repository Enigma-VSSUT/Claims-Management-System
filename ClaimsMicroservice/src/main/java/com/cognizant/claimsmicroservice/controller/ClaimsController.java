...
public class ClaimsController {
	...
	public ResponseEntity<?> getClaimStatus(@PathVariable int claimId, @PathVariable int policyId,
			@PathVariable int memberId, @RequestHeader(name = "Authorization", required = true) String token) throws ProviderNotFoundException {
	...
	public ResponseEntity<?> submitClaim(@PathVariable int policyId, @PathVariable int claimId,
			...
			@RequestHeader(name = "Authorization", required = true) String token) throws ProviderNotFoundException, BenefitsNotFoundException {
